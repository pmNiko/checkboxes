    ...
    return (
        <div className={className}>
            <div className="header-items">
                {loaded() && <span>Facturación número {items[0].n_recibo}</span>}
            </div>
            <ListItem className="header-table">
                {loaded() && (
                    <>
                        ...
                        <ListItemText
                            id={'importe'}
                            primary={`Importe segun fecha de vencimiento`}
                        />
                    </>
                )}
            </ListItem>
            ...
            {loaded() && (
                <div className="resume">
                    ...
                    <span style={{ paddingTop: '0.3em', marginRight: '1em' }}>Total a pagar:</span>
